...
# You can call a method on a string (upper, lower, title, rstrip, lstrip).
msg = "      hEllo wOrld"
print(msg)
...
print(msg.lower())
# Here the returned value "HELLO WORLD" is not printed.
msg.upper()
# Here the returned value "HELLO WORLD" is printed.
print(msg.upper())

print(msg.title())
print(msg)
# The method lstrip, strips the spaces from the left of the string.
print(msg.lstrip())
